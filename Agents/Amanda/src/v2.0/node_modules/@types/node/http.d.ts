...
declare module "http" {
    ...
    class ClientRequest extends OutgoingMessage {
         ...
         *   http.get('http://localhost:3001', { agent }, (res) => {
         *     res.on('data', (data) => {
         *       // Do nothing
         *     });
         *   });
         ...
         *   const req = http
         *     .get('http://localhost:3001', { agent }, (res) => {
         *       // ...
         *     })
         *     .on('error', (err) => {
    ...
    class IncomingMessage extends stream.Readable {
         ...
         * ```
         *
         * When `request.url` is `'/status?name=ryan'` and `request.getHeaders().host` is `'localhost:3001'`:
         *
         * ```console
         * $ node
         * > new URL(request.url, `http://${request.getHeaders().host}`)
         * URL {
         *   href: 'http://localhost:3001/status?name=ryan',
