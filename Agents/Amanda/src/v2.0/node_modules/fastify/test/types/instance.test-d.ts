...
expectAssignable<void>(server.listen(3001, '', 0, (err, address) => {
  expectType<Error | null>(err)
}))
expectAssignable<void>(server.listen('3001', '', 0, (err, address) => {
  expectType<Error | null>(err)
}))
expectAssignable<void>(server.listen(3001, '', (err, address) => {
  expectType<Error | null>(err)
}))
expectAssignable<void>(server.listen('3001', '', (err, address) => {
  expectType<Error | null>(err)
...
expectAssignable<PromiseLike<string>>(server.listen(3001))
expectAssignable<PromiseLike<string>>(server.listen('3001'))
expectAssignable<PromiseLike<string>>(server.listen(3001, '', 0))
expectAssignable<PromiseLike<string>>(server.listen('3001', '', 0))
expectAssignable<PromiseLike<string>>(server.listen(3001, ''))
expectAssignable<PromiseLike<string>>(server.listen('3001', ''))

// Test variadic listen signatures Typescript deprecation
expectDeprecated(server.listen(3001))
expectDeprecated(server.listen('3001'))
expectDeprecated(server.listen(3001, '', 0))
expectDeprecated(server.listen('3001', '', 0))
expectDeprecated(server.listen(3001, ''))
expectDeprecated(server.listen('3001', ''))
...
expectAssignable<PromiseLike<string>>(server.listen({ port: 3001 }))
expectAssignable<PromiseLike<string>>(server.listen({ port: 3001, listenTextResolver: (address) => { return `address: ${address}` } }))
expectAssignable<PromiseLike<string>>(server.listen({ port: 3001, host: '0.0.0.0' }))
expectAssignable<PromiseLike<string>>(server.listen({ port: 3001, host: '0.0.0.0', backlog: 42 }))
expectAssignable<PromiseLike<string>>(server.listen({ port: 3001, host: '0.0.0.0', backlog: 42, exclusive: true }))
expectAssignable<PromiseLike<string>>(server.listen({ port: 3001, host: '::/0', ipv6Only: true }))

expectAssignable<void>(server.listen(() => {}))
expectAssignable<void>(server.listen({ port: 3001 }, () => {}))
expectAssignable<void>(server.listen({ port: 3001, listenTextResolver: (address) => { return `address: ${address}` } }, () => {}))
expectAssignable<void>(server.listen({ port: 3001, host: '0.0.0.0' }, () => {}))
expectAssignable<void>(server.listen({ port: 3001, host: '0.0.0.0', backlog: 42 }, () => {}))
expectAssignable<void>(server.listen({ port: 3001, host: '0.0.0.0', backlog: 42, exclusive: true }, () => {}))
expectAssignable<void>(server.listen({ port: 3001, host: '::/0', ipv6Only: true }, () => {}))

// test listen opts objects Typescript deprecation exclusion
expectNotDeprecated(server.listen())
expectNotDeprecated(server.listen({ port: 3001 }))
expectNotDeprecated(server.listen({ port: 3001, host: '0.0.0.0' }))
expectNotDeprecated(server.listen({ port: 3001, host: '0.0.0.0', backlog: 42 }))
expectNotDeprecated(server.listen({ port: 3001, host: '0.0.0.0', backlog: 42, exclusive: true }))
expectNotDeprecated(server.listen({ port: 3001, host: '::/0', ipv6Only: true }))
