 ...
 * @whatsapp WAWebContactUtils >= 2.3001.0
 * @note Function name changed from canSaveAsMyContacts (plural) to canSaveAsMyContact (singular) in newer versions (>= 2.3001.10286.x)
 */
