 ...
 * - VERSION_STR: Full version string (e.g., "2.3001.1234567")
 * - VERSION_BASE: Base version (e.g., "2.3001.1234567")
 ...
 * @example
 * ```javascript
 * // Check if version is >= 2.3001.1030110621
 * if (WPP.conn.isWhatsAppVersionGTE('2.3001.1030110621')) {
 *   console.log('Using new API');
 * }
 * ```
 *
 * @param version - Version string to compare against (e.g., "2.3001.1029")
 ...
 * @example
 * ```javascript
 * // Check if version is <= 2.3001.1029960097
 * if (WPP.conn.isWhatsAppVersionLTE('2.3001.1029960097')) {
