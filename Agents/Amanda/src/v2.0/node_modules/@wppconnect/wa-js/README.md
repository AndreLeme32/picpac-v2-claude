...
WA_VERSION="2.3001.1029560485" npm run launch:local
```
...
./scripts/compare-wa-versions.sh 2.3001.1031980585 2.3001.1031992593

# Compare a specific module between versions
./scripts/compare-wa-versions.sh 2.3001.1031980585 2.3001.1031992593 WAWebUpdateUnreadChatAction
